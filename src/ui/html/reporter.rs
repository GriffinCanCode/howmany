...
impl HtmlReporter {
    ...
    pub fn generate_report(
        ...
        let html_content = self
            .standard_generator
            .create_html_content(stats, individual_files)?;
    ...
    pub fn generate_comprehensive_report(
        ...
        let html_content = self
            .standard_generator
            .create_comprehensive_html_content(aggregated_stats, individual_files)?;
        fs::write(output_path, html_content)?;
        Ok(())
    }
    ...
    pub fn generate_auto_report(
        ...
        match (stats, aggregated_stats) {
            ...
            (None, None) => Err(crate::utils::errors::HowManyError::invalid_config(
                "No statistics provided for report generation".to_string(),
            )),
        }
    }
}
