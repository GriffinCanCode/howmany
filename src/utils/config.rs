...
impl HowManyConfig {
    pub fn load() -> Result<Self> {
        ...
        if config_path.exists() {
            ...
            let config: HowManyConfig = toml::from_str(&content).map_err(|e| {
                HowManyError::invalid_config(format!("Failed to parse config: {}", e))
            })?;
            Ok(config)
        } else {
            Ok(Self::default())
    ...
    pub fn save(&self) -> Result<()> {
        ...
        let content = toml::to_string_pretty(self).map_err(|e| {
            HowManyError::invalid_config(format!("Failed to serialize config: {}", e))
        })?;
    ...
    fn default_language_extensions() -> HashMap<String, Vec<String>> {
        ...
        map.insert(
            "css".to_string(),
            vec!["css".to_string(), "scss".to_string(), "sass".to_string()],
        );
        map.insert(
            "markdown".to_string(),
        ...
        map.insert(
            "haskell".to_string(),
            vec!["hs".to_string(), "lhs".to_string(), "hsc".to_string()],
        );
        map.insert(
            "elixir".to_string(),
            vec!["ex".to_string(), "exs".to_string(), "eex".to_string()],
        );
        map.insert(
            "erlang".to_string(),
            vec!["erl".to_string(), "hrl".to_string()],
        );
        map.insert("julia".to_string(), vec!["jl".to_string()]);
        map.insert("lua".to_string(), vec!["lua".to_string()]);
        map.insert(
            "perl".to_string(),
            vec!["pl".to_string(), "pm".to_string(), "pod".to_string()],
        );
        map.insert(
            "matlab".to_string(),
            vec!["m".to_string(), "mlx".to_string()],
        );
        ...
        map.insert(
            "clojure".to_string(),
            vec!["clj".to_string(), "cljs".to_string(), "cljc".to_string()],
        );
        map.insert(
            "powershell".to_string(),
            vec!["ps1".to_string(), "psm1".to_string(), "psd1".to_string()],
        );
        map.insert(
            "batch".to_string(),
        ...
        map.insert(
            "visualbasic".to_string(),
            vec!["vb".to_string(), "vbs".to_string()],
        );
